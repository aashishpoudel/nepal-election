...
def classify_education_group(education_raw: Optional[str]) -> str:
    ...
    masters_kw = [
        "स्‍नात्तकोत्तर", "स्‍नाक्तोर", "स्‍नाकोत्तर", "स्नोकोत्तर", "स्नात्तकोत्तर","स्‍नात्तकोतर","स्‍नात्तकोत्तोर","स्नातकोत्तर","स्नोकोत्तर",
        "स्‍नातोकत्तर", "स्‍नातकोत्तर", "स्‍नातकोतर", "स्नात्तकोतर", "स्नात्कोत्तर","स्नातकोत्तर", "स्नात्तकोत्तोर",
        ...
        "एम‍ए", "एम्फिल", "एमफिल", "एमवियस", "एमबिइ", "एमएड",
        "ma", "med", "ms", "एमविए", "एमपिए", "एमटेक","mba","mteck",
        "mpa", "llm", "mca", "mbs", "एमई", "dm"
    ]
    ...
    intermediate_kw = [
        ...
        "नर्सिङ", "उच्चशिक्षा", "आयएससि", "hseb", "ied", "ha", "डिल्लोमा इन्जनियरिङ्ग", "डिप्लोमा"
    ]

    slc_kw = [
        "slc", "see", "११", "१०pass", "१०कक्षा", "१०", "म्याट्रिक", "एसइइ", "sklc",
        "भेटनरी,जेटिए", "प्रवेशिका", "एसएलसि", "दशौंकक्षा", "एसएससि", "एलएलसि", "ऐसएलसि",
        "अहेव", "एसलसि","टेष्ट पास", "दशौं पास", "दश कक्षा", "दश पास", "दसौं पास", "दस कक्षा", "दस पास",
         "१०औं पास", "१०औं कक्षा", "१०औं", "१० पास", "१० कक्षा", "१०उतिर्ण", "१०उतिर्ण", "१०उतिर्ण", "१०", "१०कक्षा", "१०पास"
    ]
    ...
    if contains_any(edu, phd_kw_n):
        return "PhD"
    if "bachelorofmedicine" in edu or 'bcahelorofmedicine' in edu: #overwriting finding 'med' in medicine and classifying as Masters
        return "Bachelors"
    if 'डिप्लोमा' in edu or 'intermediate' in edu: #overwriting 'डिप्लोमा इन्जिनियरिङ्ग' or 'med' in intermediate
        return "Intermediate"
